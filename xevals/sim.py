...
from .envs import (
    ENVS,
    IN_DISTRIBUTION_OBJECTS,
    OOD_OBJECTS,
    SPLITS,
    _draw_text,
)
from .errors import MissingExtra
from .types import Obs, SafetyLimits
...
class ManipulationEnv:
    ...
    def optimal_action(self) -> np.ndarray:
        ...
        worth reading. It is stateless, inferring its phase from where the tool
        and the object are, so it survives being called at any point.
        """
